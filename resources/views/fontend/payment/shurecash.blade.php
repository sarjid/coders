...
@section('title')ShureCash Payment @endsection
            ...
            <div class="container">
                <form action="{{ url('order/store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" value="ShureCash" name="payment_type">
                    @if (Session::has('coupon'))
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label>ShureCash No.</label>
                                            <input type="text" class="form-control" value="01776620826" disabled>
                                        @if (Session::has('coupon'))
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label>Your ShureCash No. <span class="required">*</span></label>
                                            <input type="number" class="form-control" name="payment_no" value="{{ old('payment_no') }}" placeholder="Your ShureCash Account No" data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
