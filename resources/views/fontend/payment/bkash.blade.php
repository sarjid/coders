                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="01722260010" disabled>
                                        @if (Session::has('coupon'))
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="payment_no" value="{{ old('bkash_no') }}" placeholder="Your Bkash Account No" data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
